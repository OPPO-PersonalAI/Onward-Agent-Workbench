...
if (-not $LogFile) {
  $LogFile = Join-Path $env:TEMP "onward-prompt-sender-autotest.log"
}
...
Write-Host "Starting prompt sender autotest..."

$env:ONWARD_DEBUG = "1"
$env:ONWARD_AUTOTEST = "1"
$env:ONWARD_AUTOTEST_SUITE = "prompt-sender"
...
if ($logContent -match "\[AutoTest\] FAIL") {
  Write-Error "Prompt sender autotest failed. Log: $LogFile"
...
Write-Host "Prompt sender autotest passed. Log: $LogFile"
