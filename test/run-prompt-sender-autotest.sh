...
LOG_FILE="${2:-/tmp/onward-prompt-sender-autotest.log}"
...
echo "Starting prompt sender autotest..."
echo "  Binary: $APP_BIN"
echo "  CWD:    $ROOT_DIR"
echo "  Log:    $LOG_FILE"
echo ""
...
ONWARD_DEBUG=1 \
ONWARD_AUTOTEST=1 \
ONWARD_AUTOTEST_SUITE=prompt-sender \
...
if grep -q "\[AutoTest\] FAIL" "$LOG_FILE"; then
  echo "Prompt sender autotest failed" >&2
  echo ""
...
echo "Prompt sender autotest passed"
echo "  Log: $LOG_FILE"
