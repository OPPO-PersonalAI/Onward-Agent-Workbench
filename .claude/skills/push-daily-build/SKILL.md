...
description: Push local commits, create a daily build tag, trigger GitHub Actions CI, and verify the entire release pipeline. Use this skill when the user says "push and trigger daily build", "create a tag", "publish a daily build", "trigger a build", or wants to push code and create a release tag.
---
